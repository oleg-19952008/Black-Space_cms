                    ...
                    <tr>
                        ...
                        <td>
                            <select name="signup_instance" onchange="changeInstance(this.value);" class="input_selectInstance" tabindex="32767" >
                                <option value="1" selected="selected">Global</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
            ...
            <div>
                <nav class="clearfix">
                    ...
                    <h1>	<a class="logo" href="http://<?php echo DynHost; ?>/">
                            <img src="./do_img/global/splashpage/logoDP.png"  height="52" alt="Dark Planets"></a>
                    </h1>
                    <ul class="clearfix">
						...
						<li>
						<iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FdarkplanetsNET&amp;width&amp;layout=button_count&amp;action=like&amp;show_faces=true&amp;share=true&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:21px;" allowTransparency="true"></iframe>
						</li>
                    </ul>
                </nav>
                <div class="ccp-loginwidget">
                    <div class="ccploginwidget-sites"><a href="#">Dark Planets Zone</a>
                        <ul>
                            <li>
