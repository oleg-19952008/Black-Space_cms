    ...
    <div class="overallContainer">
        ...
        <div class="outerContainer fliess11px-gelb">
            ...
            <div id="editClaninfo" class="fliess10px-white" style="position:absolute;top:50px;left:254px;width:352px;">
                ...
                <div><input type="text" id="clan_name" name="clan_name" value="Bau" class="changeInfo_name_input fliess10px-white"></div>
                <div class="changeInfo_tag_title"><label for="clan_tag">Clan tag:</label></div>
                <div><input type="text" id="clan_tag" name="clan_tag" value="Bau" maxlength="4" class="changeInfo_tag_input fliess10px-white"></div>
...
<div id="editClanText" style="position:absolute;top:50px;left:254px;width:352px;" class="fliess10px-white">
    ...
    <div id="editClanText_cont">
        <textarea cols="17" rows="4" name="clandescription" style="width:286px;height:94px;border:none;background-color:transparent;padding:5px;" class="scrollbars fliess10px-white">Bau</textarea>
    </div>
    <br class="clearMe">
    <div>
