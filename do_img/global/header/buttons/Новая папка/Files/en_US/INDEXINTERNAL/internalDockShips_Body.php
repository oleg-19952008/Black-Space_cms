...
<?php require GLOBALS . 'internalHeaderIntern.php'; ?>
    ...
    <div id="subNavTop">
        ...
        <ul>
            <li title="Naves"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockShips" style="background-image: url(./do_img/global/hangar/subnav_button_405x33.png?__cv=585dbec7500b7493d5c6ed734dd57000);background-position: -268px 0px;"><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_ships&f=eurostyle_clan"></a></li>
            <li title="Vehículos aéreos no tripulados"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockDrones" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_drones&f=eurostyle_clan"></a></li>
            <li title="Armas"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockLasers" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_weapons&f=eurostyle_clan"></a></li>
            <li title="Munición"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockAmmo" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_ammunition&f=eurostyle_clan"></a></li>
            <li title="Generators"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockGenerator" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_generators&f=eurostyle_clan"></a></li>
            <li title="Extras"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockSpecials" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_extras&f=eurostyle_clan"></a></li>
            <li title="Potenciador"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockBooster" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_boosters&f=eurostyle_clan"></a></li>
            <li title="Diseños"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockShipModel" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_designs&f=eurostyle_clan"></a></li>
            <li title="P.E.T./MÓDULOS"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockPetGear" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_pet_gear&f=eurostyle_clan"></a></li>
            <li title="PROTOCOLOS IA"><a onfocus="this.blur()" href="indexInternal.es?action=internalDock&tpl=internalDockPetProtocols" ><img src="./do_img/global/nav_left.esg?s=10&locale=en&lang=en&t=nav_sub1_hangar_pet_protocols&f=eurostyle_clan"></a></li>
        </ul>
            </div>
