                ...
                <div id="overview_content">
                    ...
                    <div id="overview_drones">
                        ...
                        <div style="display: none;" class="infoBox infoBox_ship fliess10px-weiss" id="infoBox_droneView">
                                ...
                                <img id="droneName" src="./do_img/global/text.esg?l=en&s=17&t=Iris&uc=1&f=ship_name"><br />
                                                                <img id="droneTitle" class="droneTitle" src="./do_img/global/text.esg?l=en&s=12&t=Battle drone&uc=1&cs=1&f=ship_title">
                                                                <br class="clearMe" />
                            </div>
