...
class Connexion 
{
    ...
    public static function bdd() {     
        try 
        {
            $bdd = new PDO('mysql:host=127.0.0.1;dbname=darkorbit_new', 'root', '');
